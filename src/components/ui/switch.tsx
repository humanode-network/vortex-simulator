  ...
  ({ className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <span className="absolute left-0.5 h-5 w-5 rounded-full border border-border bg-panel shadow-[var(--shadow-control)] ring-1 ring-[color:var(--glass-border)] transition ring-inset peer-checked:translate-x-5" />
      </label>
    );
  },
);
