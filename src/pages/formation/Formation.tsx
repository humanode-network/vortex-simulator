    ...
    <div className="app-page formation-page">
      ...
      <section className="formation-search" role="search">
        ...
        <div className="formation-search__field">
          <input id="formation-search" type="search" placeholder="Search by project, proposer, focus…" />
      ...
      <section className="formation-grid">
        <article className="formation-card">
          ...
          <div className="formation-card__footer">
            ...
            <Link className="btn btn--small btn--primary" to="/formation/node-health-kit">
              Open project
            </Link>
          </div>
        </article>
        ...
        <article className="formation-card">
          ...
          <div className="formation-card__footer">
            ...
            <Link className="btn btn--small btn--primary" to="/formation/identity-risk-lab">
              Open project
            </Link>
          </div>
        </article>
